      ...
      child: Column(
        ...
        children: [
          ...
          _buildCompactSection('📚 Formations', [
            ...
            _buildCompactCheckbox('Autre', _conditions.formationAutre,
                (value) => _updateConditions(_conditions.copyWith(formationAutre: value))),
          ]),

          // Champ de saisie pour "Autre formation" (affiché seulement si "Autre" est coché)
          if (_conditions.formationAutre) ...[
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    onChanged: (value) => _updateConditions(_conditions.copyWith(formationAutreTexte: value)),
                    decoration: const InputDecoration(
                      hintText: 'Ex: Formation Sécurité Avancée',
